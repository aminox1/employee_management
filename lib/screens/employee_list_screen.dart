...
const Color primaryColor = Color(0xFFEE82EE); // Violet
const Color accentColor = Color(0xFFFFC107); // Jaune
...
class _EmployeeListScreenState extends State<EmployeeListScreen> {
  ...
  void initState() {
    super.initState();
    // The provider will automatically load employees in its constructor
  }
